...
a{color:inherit}
header{background:var(--surface);border-bottom:1px solid var(--border);padding:26px 38px 18px}
...
.toolbar{position:sticky;top:0;z-index:40;background:rgba(255,255,255,.96);-webkit-backdrop-filter:blur(16px);backdrop-filter:blur(16px);border-bottom:1px solid var(--ui-line);padding:10px 38px;display:flex;align-items:center;gap:8px;flex-wrap:wrap}
...
.band-dot{width:8px;height:8px;border-radius:50%;display:inline-block;margin-right:6px}.open-btn{display:inline-block;font-family:'Inter',sans-serif;font-size:10px;font-weight:700;letter-spacing:.06em;color:var(--ui-ink);text-decoration:none;padding:5px 10px;border:1px solid var(--border-strong);border-radius:4px;white-space:nowrap;background:var(--surface)}.open-btn:hover{background:var(--ui-hover);border-color:var(--ui-active)}
